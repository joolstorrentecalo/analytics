...
, dim_date_actual AS (
    ...
    SELECT
      ...
      mart_arr_snapshot_model.snapshot_date,
      ...
      mart_arr_snapshot_model.product_deployment_type,
      ...
      mart_arr_snapshot_model.is_jihu_account
    FROM mart_arr_snapshot_model
    LEFT JOIN dim_product_detail ON mart_arr_snapshot_model.dim_product_detail_id = dim_product_detail.dim_product_detail_id
