...
SELECT 
  ...
  MAX(TRY_TO_TIMESTAMP(column_selection.connect_end))                          AS connect_end,
  MAX(TRY_TO_TIMESTAMP(column_selection.connect_start))                        AS connect_start,
  MAX(TRY_TO_TIMESTAMP(column_selection.dom_complete))                         AS dom_complete,
  MAX(TRY_TO_TIMESTAMP(column_selection.dom_content_loaded_event_end))         AS dom_content_loaded_event_end,
  MAX(TRY_TO_TIMESTAMP(column_selection.dom_content_loaded_event_start))       AS dom_content_loaded_event_start,
  MAX(TRY_TO_TIMESTAMP(column_selection.dom_interactive))                      AS dom_interactive,
  MAX(TRY_TO_TIMESTAMP(column_selection.dom_loading))                          AS dom_loading,
  MAX(TRY_TO_TIMESTAMP(column_selection.domain_lookup_end))                    AS domain_lookup_end,
  MAX(TRY_TO_TIMESTAMP(column_selection.domain_lookup_start))                  AS domain_lookup_start,
  MAX(TRY_TO_TIMESTAMP(column_selection.fetch_start))                          AS fetch_start,
  MAX(TRY_TO_TIMESTAMP(column_selection.load_event_end))                       AS load_event_end,
  MAX(TRY_TO_TIMESTAMP(column_selection.load_event_start))                     AS load_event_start,
  MAX(TRY_TO_TIMESTAMP(column_selection.navigation_start))                     AS navigation_start,
  MAX(TRY_TO_TIMESTAMP(column_selection.redirect_end))                         AS redirect_end,
  MAX(TRY_TO_TIMESTAMP(column_selection.redirect_start))                       AS redirect_start,
  MAX(TRY_TO_TIMESTAMP(column_selection.request_start))                        AS request_start,
  MAX(TRY_TO_TIMESTAMP(column_selection.response_end))                         AS response_end,
  MAX(TRY_TO_TIMESTAMP(column_selection.response_start))                       AS response_start,
  MAX(TRY_TO_TIMESTAMP(column_selection.secure_connection_start))              AS secure_connection_start,
  MAX(TRY_TO_TIMESTAMP(column_selection.unload_event_end))                     AS unload_event_end,
  MAX(TRY_TO_TIMESTAMP(column_selection.unload_event_start))                   AS unload_event_start
