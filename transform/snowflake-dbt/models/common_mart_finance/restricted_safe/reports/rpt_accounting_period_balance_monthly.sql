...
/* Joining all data by period monthly */
  ...
  FULL OUTER JOIN payment_amounts ON payment_amounts.period = period
  FULL OUTER JOIN overpayments ON overpayments.period = period
  FULL OUTER JOIN refund_amounts ON refund_amounts.period = period
  FULL OUTER JOIN iia_amounts ON iia_amounts.period = period
  FULL OUTER JOIN aging_bucket_1 ON aging_bucket_1.period = period
  FULL OUTER JOIN aging_bucket_2 ON aging_bucket_2.period = period
  FULL OUTER JOIN aging_bucket_3 ON aging_bucket_3.period = period
  FULL OUTER JOIN aging_bucket_4 ON aging_bucket_4.period = period
  FULL OUTER JOIN aging_bucket_5 ON aging_bucket_5.period = period
  FULL OUTER JOIN aging_bucket_6 ON aging_bucket_6.period = period
  FULL OUTER JOIN aging_bucket_total ON aging_bucket_total.period = period
