...
FULL OUTER JOIN payment_amounts ON payment_amounts.period = invoice_amounts.period
FULL OUTER JOIN overpayments ON overpayments.period = invoice_amounts.period
FULL OUTER JOIN refund_amounts ON refund_amounts.period = invoice_amounts.period
FULL OUTER JOIN iia_amounts ON iia_amounts.period = invoice_amounts.period
FULL OUTER JOIN aging_bucket_1 ON aging_bucket_1.period = invoice_amounts.period
FULL OUTER JOIN aging_bucket_2 ON aging_bucket_2.period = invoice_amounts.period
FULL OUTER JOIN aging_bucket_3 ON aging_bucket_3.period = invoice_amounts.period
FULL OUTER JOIN aging_bucket_4 ON aging_bucket_4.period = invoice_amounts.period
FULL OUTER JOIN aging_bucket_5 ON aging_bucket_5.period = invoice_amounts.period
FULL OUTER JOIN aging_bucket_6 ON aging_bucket_6.period = invoice_amounts.period
FULL OUTER JOIN aging_bucket_total ON aging_bucket_total.period = invoice_amounts.period
FULL OUTER JOIN credit_balance ON credit_balance.period = invoice_amounts.period
FULL OUTER JOIN future_dated_refunds_payments ON future_dated_refunds_payments.period = invoice_amounts.period
...
FROM ending_ar
LEFT JOIN dim_date ON dim_date.date_actual = ending_ar.period
