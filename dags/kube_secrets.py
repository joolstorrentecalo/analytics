...
TABLEAU_CONFIG_SSH_CONFIG = Secret(
    "env", "TABLEAU_CONFIG_SSH_CONFIG", "airflow", "TABLEAU_CONFIG_SSH_CONFIG"
)
TABLEAU_CONFIG_SSH_KEY = Secret(
    "env", "TABLEAU_CONFIG_SSH_KEY", "airflow", "TABLEAU_CONFIG_SSH_KEY"
)
